...
<html style="" class=" js flexbox flexboxlegacy canvas canvastext webgl no-touch geolocation postmessage no-websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients no-cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths" lang="en">
    ...
    <body style="overflow: visible;">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="/htmls/home.php?_dc=fdfs&page=blog&sTgt=home" class="page-scroll" href="#banner">Home</a></li>
                        <li><a href="/htmls/workshops.php?_dc=fdfs&page=workshops&sTgt=site">Workshop</a></li>
                        <li class="active"><a href="/htmls/courses.php?_dc=fdfs&page=courses&sTgt=site">Courses</a></li>
                        <li class=""><a class="page-scroll" href="#basic_course">Basic</a></li>
                        <li class=""><a class="page-scroll" href="#advance_course">Advance</a></li>
        ...
        <header id="banner" class="carousel slide zoom carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner"><!-- Inner wrapper for slides -->
                ...
                <div class="item active"> <!-- Second item slider -->
                    <img src="/images/02_bg.jpg" alt="banner-img"> <!-- Second item background image slider -->
                    <div class="carousel-caption">
                        <div class="content">
                            <div class="text wow bounceIn animated" style="visibility: visible; animation-name: bounceIn;">
                                <h1>Basic Photography Course</h1>
                                <hr>
                            </div>
                        </div>
                ...
                <div class="item"> <!-- Fourth item slider -->
                    <img src="/images/04_bg.jpg" alt="banner-img"> <!-- Fourth item background image slider -->
                    <div class="carousel-caption">
                        <div class="content">
                            <div class="text wow bounceIn animated" style="visibility: visible; animation-name: bounceIn;">
                                <h1>Advance Photography Course</h1>
                                <hr>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2" style="text-align: left;">
                            ...
                            <div class="about-text">
                                ...
                                <p class="large">2) Who can enroll for the weekend courses ? </p> 
        ...
        <!-- FAQ Modal 1 -->
        <div class="portfolio-modal modal fade" id="feesModal1" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-content">
                <div class="close-modal" data-dismiss="modal">
                    <div class="lr">
                        <div class="rl">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2" style="text-align: left;">
                            <p class="large">
                                <b>Weekend Workshop Fee  </b>
                                <br>For Indian Students                   : Rs 500* 
                                <br>For International Students            : $ 8*
                                <br><br>
                                <b>Course Fee  for Advanced Photography course</b>
                                <br>For Indian Students                   : Rs 6250*
                                <br>For International Students            : $ 150*
                                <br><br><b>Course Fee for Basic & Advanced course</b>
                                <br>For Indian Students                   : Rs 9250*
                                <br>For International Students            : $ 220* 
                                <br>*Service Tax Applicable
                            </p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2" style="text-align: left;">
                            <p class="large">
                                ...
                                <br><b>Note</b> Only NEFT/IMPS Transfer
                                <br>Bank Name  :   RBL - Ratnakar Bank
                                <br>Branch     :   Airoli Navi Mumbai
                                <br>Account    :   1009310010000771
                                <br>IFSC Code  :   RATN0000093
                                <br>MICR Code  :   400176018
                                <br><br>Please send payment confirmation on photoes@creativelights.in with your contact details.
                            </p>
                            <p class="large">
                                <b>Contact Details:</b> 
                                <br>Neeta Dhakad
                                <br>photoes@creativelights.in
                                <br>+91-9819440746
                            </p>
                        </div>
                    </div>
            ...
            <div class="container"> <!-- Container -->
                <div class="row">
                    <div class="col-md-12" style="text-align:center;">
                        <a id="show" class="btn wow bounceIn animated" data-wow-delay="0.6s" style="visibility: visible; animation-delay: 0.6s; animation-name: bounceIn;">
                            <h2>ENROLL NOW</h2>
                        </a> 
                    </div>
                </div>
